...
function validate_inputs(input)
{
  ...
  var config = {
    ...
    eversenseTimezoneOffset: input.eversenseTimezoneOffset !== undefined
      ? parseInt(input.eversenseTimezoneOffset, 10)
      : -120,
    eversenseTimezoneName:   input.eversenseTimezoneName || 'Europe/Berlin',
    kind: 'eversense'
  };
  ...
  var impl = {
    ...
    authFromCredentials: function()
    {
      ...
      return axios.post(tokenUrl, params.toString(), {
        ...
        var body   = err.response ? JSON.stringify(err.response.data || '').substring(0, 200) : err.message;
    ...
    dataFromSesssion: function(session, last_known)
    {
      ...
      return tokenPromise.then(function(td)
      {
        ...
        var dashUrl = ep.apiBase
          ...
          + '?timeZoneOffset=' + opts.eversenseTimezoneOffset
          + '&timeZoneName=' + encodeURIComponent(opts.eversenseTimezoneName);
        ...
        }).then(function(dashR)
        {
          ...
          if (!dash.UserDeviceInfo || !dash.UserDeviceInfo.DeviceID) {
            ...
            return { dashboard: dash, agp: null };
          }
          ...
          var agpBody = {
            ...
            ToDateStr:       toStr,
            IsDashboard:     true,
            timeZoneName:    opts.eversenseTimezoneName
          };

          return axios.post(ep.apiBase + '//api/AgpReportV5/GetDetailsOnDateFilter',
            agpBody,
            {
            ...
            console.log('EVERSENSE: AGP HTTP=' + agpR.status);
            var agp = (agpR.status === 200 && agpR.data && !agpR.data.Message) ? agpR.data : null;
            return { dashboard: dash, agp: agp };
          });
        });
      });
    },
