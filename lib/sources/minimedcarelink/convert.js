...
//  Timestamp-Handling 
//
// CareLink liefert ISO-Strings OHNE Timezone-Suffix (lokale Pump-Zeit).
// Wir behandeln sie als UTC (kein Offset). Bei Bedarf kann clientTimeZoneName
// spaeter fuer Korrektur genutzt werden.
...
function extractEntries(raw)
{
  ...
  // Letzter Trend gilt fuer neuesten Eintrag
  var lastTs = 0;
  console.log("sgs[0]:", JSON.stringify(sgs[0]||{}));
